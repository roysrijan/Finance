                ...
                <Container fluid>
                  ...
                  <Navbar.Collapse id="basic-navbar-nav" className="navBarTop">
                    <Nav className="me-auto">
                      ...
                      <Nav.Link className="wallet" onClick={() => user?'':setShow(true)}>{user?'connected':'Connect wallet'}</Nav.Link>
                    </Nav>
                  </Navbar.Collapse>
                </Container>
              </Navbar>
